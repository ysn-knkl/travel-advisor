...
const PlaceDetails = ({ place }) => {
    ...
    return (
        <Card elevation={6}>
            <CardMedia 
                style={{ height:350}}
                image={place.photo ? place.photo.images.large.url :"https://media.istockphoto.com/photos/wood-table-top-and-blurred-restaurant-interior-background-can-used-picture-id655651736"}
                title={place.name}
            />
            <CardContent>
